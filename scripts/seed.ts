...
const BRANDS_DATA = [
  ...
  { slug: 'clashgg', displayName: 'CLASH.GG', logoUrl: '/images/brands/clashgg.png', sortOrder: 4 },
  ...
  { slug: 'empiredrop', displayName: 'EMPIREDROP', logoUrl: '/images/brands/empiredrop.png', sortOrder: 11 },
