...
// ── Inner form (remounts on key change to reset state) ────────────────────────
...
function CampaignForm({
  ...
  return (
    <>
      {/* Footer rendered via EditDrawer footer prop — we pass it up via a portal-like pattern.
          Since EditDrawer accepts footer as a prop, we render the form + footer together
          and use a form id to connect the submit button. */}
      <form
