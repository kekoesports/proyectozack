...
import { CampaignSummaryCard } from '@/components/admin/campaigns/CampaignSummaryCard';
import { CampaignPayments } from '@/components/admin/campaigns/CampaignPayments';
import { CampaignFiles } from '@/components/admin/campaigns/CampaignFiles';
