  ...
  return {
    ...
    inbox: [
      ...
      },
      {
        ...
        evidence: `${workspaceName} CRM · última actividad 25 ago`, owner: 'María Corvo', due: 'Hace 2 d', action: 'Abrir deal',
        href: '/admin/campanas/1047', category: 'Bloqueos',
      },
      {
        id: 'run-8', priority: 2, state: 'Error', tone: 'danger', title: `${agentName} Deal Clerk · ejecución 8`,
    ...
    sidePanels: [
      { title: 'Propuestas de los agentes', meta: '2 esperan decisión', rows: [
        { title: `${agentName} Deal Clerk`, body: '8 ejecuciones · 1 fallida en 7 d', value: '2', tone: 'attention', href: '/admin/agents' },
        { title: `${agentName} CRM`, body: '12 ejecuciones · 0 fallidas en 7 d', value: '0', tone: 'success', href: '/admin/agents' },
      ] },
      ...
      { title: `Operación ${workspaceName}`, meta: 'fuente canónica', rows: [
    ...
    dealDetails: {
      '1042': {
        ...
        activity: [
          ...
          { id: 'crm-1042', kind: 'Información', tone: 'neutral', source: `${workspaceName} CRM`, when: '2 sep', text: 'El deal está activo.', evidence: `campaigns · ${referencePrefix}-1042` },
        ],
      },
      '1047': {
        ...
        activity: [{ id: 'crm-1047', kind: 'Información', tone: 'neutral', source: `${workspaceName} CRM`, when: '25 ago', text: 'El deal está en propuesta.', evidence: `campaigns · ${referencePrefix}-1047` }],
      },
      '1028': {
        deal: sela, stage: 'Cierre y cobro', crmHref: '/admin/campanas/1028', deliverables: [], documents: [], alerts: [],
        activity: [{ id: 'crm-1028', kind: 'Información', tone: 'neutral', source: `${workspaceName} CRM`, when: '1 sep', text: 'El deal está pagado.', evidence: `campaigns · ${referencePrefix}-1028` }],
      },
    },
  };
}
