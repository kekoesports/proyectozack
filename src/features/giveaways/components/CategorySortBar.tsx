...
/**
 * Barra de filtros por categoría y orden para el hub de giveaways.
 *
 * @kind client
 * @feature giveaways
 * @route /giveaways
 * @example
 * ```tsx
 * <CategorySortBar category={category} sort={sort} onCategoryAction={setCat} onSortAction={setSort} />
 * ```
 */
