...
/**
 * Barra de filtros (búsqueda + chips) para el hub de giveaways.
 *
 * @kind client
 * @feature giveaways
 * @route /giveaways
 * @example
 * ```tsx
 * <FiltersBar query={query} onQueryAction={setQuery} platform={platform} onPlatformAction={setPlatform} />
 * ```
 */
export function FiltersBar({
  ...
  return (
    <div className="sticky top-[84px] z-30 py-2 mb-6 border-b border-white/[0.05] bg-[#09090f]/85 backdrop-blur-md">
