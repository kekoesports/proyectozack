...
// @allow-sensitive-copy: card de partner externo (SkinsMonkey). El copy comercial ("35% Bonus + 5$
// Gratis") es información objetiva del partner. Renderizado detrás de consent gate en
// `BrandBonusesSection`.
 ...
 *   - v2: card compacta con altura equivalente a CSGO-SKINS. La
 ...
 *   - Fase 0 legal: `PartnerExternalNotice` obligatorio + consent gate
 *     upstream (ver `BrandBonusesSection`).
 */
export function BrandCardSkinsMonkey({ code }: Props) {
  const brand = PLATFORM_BRANDS.skinsmonkey;
  return (
    <>
      <PartnerExternalNotice partner="SkinsMonkey" category="skin_market" />
