...
/**
 * Botón de upload reutilizable que dispara `onFile` con el `File` seleccionado.
 * El consumidor decide qué hacer (típicamente subir a Vercel Blob).
 *
 * @kind client
 * @feature admin/files
 * @example
 * ```tsx
 * <FileUploadButton accept=".pdf" onFile={(f) => uploadToBlob(f)} />
 * ```
 */
