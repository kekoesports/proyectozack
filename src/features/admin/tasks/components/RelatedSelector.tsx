...
/**
 * Selector de entidad relacionada para una tarea (brand, talent, campaign, invoice o general).
 * Usa hidden inputs para integrarse en formularios y permite búsqueda dentro del tipo elegido.
 *
 * @kind client
 * @feature admin/tasks
 */
