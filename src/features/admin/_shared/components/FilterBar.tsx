...
/**
 * Barra de filtros sticky con sub-componentes compuestos (Search, Select, Reset) para listados admin.
 *
 * @kind server
 ...
 * ```tsx
 * <FilterBar>
 *   <FilterBar.Search value={q} onChange={onQ} />
 *   <FilterBar.Select label="Estado" value={status} onChange={onStatus} options={STATUS_OPTIONS} />
 *   <FilterBar.Reset active={hasFilters} onReset={reset} />
 * </FilterBar>
 * ```
 */
