...
/**
 * Estado vacío rico (icono, título, descripción y acción) con variantes `no-data` y `no-results`.
 *
 * @kind server
 * @feature admin/_shared
 * @example
 * ```tsx
 * <EmptyState title="Sin campañas" description="Crea la primera." action={<NewCampaignButton />} />
 * ```
 */
