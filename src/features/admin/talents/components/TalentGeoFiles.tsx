...
import { FilesList } from '@/features/admin/files/components/FilesList';
...
/**
 * Sección de archivos GEO (audiencia por país) del talent con upload por plataforma y permisos de manager.
 *
 * @kind client
 ...
 * @example
 * ```tsx
 * <TalentGeoFiles talentId={talent.id} geoFiles={geoFiles} socials={socials} isManager />
 * ```
 */
