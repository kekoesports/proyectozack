...
import { TalentStatsByPlatform } from '@/features/admin/talents/components/TalentStatsByPlatform';
...
/**
 * Tabs del perfil de un talent (Stats / GEO / Negocio / Histórico de campañas) con sincronización por query param.
 *
 * @kind client
