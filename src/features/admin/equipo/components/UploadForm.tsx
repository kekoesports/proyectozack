...
/**
 * Formulario para subir/actualizar la foto pública de un miembro del equipo.
 * Muestra preview con blob URL revocada en cleanup y delega la subida a `uploadTeamPhotoAction`.
 *
 * @kind client
 * @feature admin/equipo
 * @route /admin/equipo/fotos
 */
