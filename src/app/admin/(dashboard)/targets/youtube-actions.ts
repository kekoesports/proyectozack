...
const searchSchema = z.object({
  ...
  minimumVideos: z.number().int().min(1).max(30).default(3),
...
const importSchema = z.array(z.object({
  ...
  fitScore: z.number().int().min(60).max(100),
  signals: z.array(z.string().max(300)).max(10),
