...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: absoluteUrl('/og-socialpro.png'), width: 1200, height: 630, alt: 'Agencia de Marketing Gaming e iGaming — SocialPro' }],
  },
  twitter: {
...
export default function ServiciosPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: safeJsonLd(professionalServiceJsonLd) }} />
