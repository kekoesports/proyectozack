...
export const metadata: Metadata = {
  title: 'Participación responsable · SocialPro Giveaways',
  description:
    'Participación responsable en SocialPro Giveaways: los sorteos internos son gratuitos y no son apuestas. Información y recursos de ayuda si el juego te está causando problemas. Borrador.',
  alternates: { canonical: '/sorteos/participacion-responsable' },
  robots: { index: false, follow: false },
};

export default function ParticipacionResponsablePage() {
  return (
    <>
      <header className="gp-legal-header">
        <p className="gp-legal-eyebrow">SocialPro Giveaways</p>
        <h1>Participación responsable</h1>
        <p className="gp-legal-sub">
          Última actualización del borrador: julio 2026. Los sorteos internos de SocialPro
          Giveaways son gratuitos y no constituyen apuestas. Esta página se llama
          &ldquo;participación responsable&rdquo; (y no &ldquo;juego responsable&rdquo;) porque SocialPro no es
          un operador de juego.
        </p>
      </header>
      ...
      <section className="gp-legal-section">
        ...
        <p>
          Aun así, promocionamos y enlazamos plataformas externas donde <b>sí</b> puede haber
          transacciones económicas y funcionamiento de tipo casino/cajas. Por eso incluimos
          esta guía: si vas a interactuar con esos partners, hazlo desde una decisión
          informada y responsable. Ver también{' '}
      ...
      <section className="gp-legal-section">
        ...
        <p>
          <em>
            La autoexclusión de partners externos debe solicitarse directamente ante ellos;
            SocialPro no puede ejecutarla en tu nombre.
          </em>
        </p>
      </section>
      ...
      <section className="gp-legal-section">
        ...
        <p>
          Ver también <Link href="/sorteos/terminos">Términos de uso</Link>,{' '}
          <Link href="/sorteos/privacidad">Política de privacidad</Link> y{' '}
