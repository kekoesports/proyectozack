...
const LEAD_COLUMNS = {
  ...
  country: contactSubmissions.country,
  platform: contactSubmissions.platform,
  channelUrl: contactSubmissions.channelUrl,
  contentCategory: contactSubmissions.contentCategory,
  followers: contactSubmissions.followers,
  averageAudience: contactSubmissions.averageAudience,
  otherLinks: contactSubmissions.otherLinks,
