...
export async function getCampaignWithRelations(
  ...
  const rows = await db
    .select({
      ...
      trackingReminderBaselineAt: campaigns.trackingReminderBaselineAt,
      trackingReminderAttemptAt: campaigns.trackingReminderAttemptAt,
      trackingReminderEmailSentAt: campaigns.trackingReminderEmailSentAt,
      trackingReminderDiscordNotifiedAt: campaigns.trackingReminderDiscordNotifiedAt,
      trackingReminderError: campaigns.trackingReminderError,
  ...
  return {
    ...
    trackingReminderBaselineAt: row.trackingReminderBaselineAt ?? null,
    trackingReminderAttemptAt: row.trackingReminderAttemptAt ?? null,
    trackingReminderEmailSentAt: row.trackingReminderEmailSentAt ?? null,
    trackingReminderDiscordNotifiedAt: row.trackingReminderDiscordNotifiedAt ?? null,
    trackingReminderError: row.trackingReminderError ?? null,
