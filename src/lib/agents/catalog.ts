...
export const AGENT_CATALOG: readonly AgentCatalogEntry[] = [
  ...
  },
  {
    ...
    promptVersion: 'crm-steward-v1',
    policyVersion: 'crm-steward-policy-v1',
    modelProvider: 'gemini',
    modelName: 'gemini-3.6-flash',
    maxConcurrentRuns: 1,
    maxRunsPerDay: 12,
  ...
  },
  {
    ...
    promptVersion: 'deal-clerk-v1',
    policyVersion: 'deal-clerk-policy-v1',
    modelProvider: 'gemini',
    modelName: 'gemini-3.6-flash',
    maxConcurrentRuns: 1,
    maxRunsPerDay: 24,
  ...
  },
  {
    ...
    description:
      'Resume cambios, señales de despliegue y errores; distingue la cobertura CI disponible. Solo lectura.',
    promptVersion: 'dev-v1',
